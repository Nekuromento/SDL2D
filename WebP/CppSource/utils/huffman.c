...
static int TreeInit(HuffmanTree* const tree, int num_leaves, void* (* const alloc)(const size_t, void* const), void* const allocator) {
  assert(tree != NULL);
  ...
  tree->root_ = (HuffmanTreeNode*)alloc((uint64_t)tree->max_nodes_ * sizeof(*tree->root_), allocator);
...
int HuffmanTreeBuildImplicit(HuffmanTree* const tree,
                             ...
                             int code_lengths_size, void* (* const alloc)(const size_t, void* const), void* const allocator) {
  int symbol;
  int num_symbols = 0;
  int root_symbol = 0;
  ...
  if (!TreeInit(tree, num_symbols, alloc, allocator)) return 0;
  ...
  if (num_symbols == 1) {  // Trivial case.
    ...
    int* const codes =
        (int*)alloc((uint64_t)code_lengths_size * sizeof(*codes), allocator);
...
int HuffmanTreeBuildExplicit(HuffmanTree* const tree,
                             ...
                             int num_symbols, void* (* const alloc)(const size_t, void* const), void* const allocator) {
  int ok = 0;
  int i;
